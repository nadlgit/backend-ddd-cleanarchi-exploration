...
import { TestErrorTrigger } from '../../test-utils/helpers/test-error-trigger';

export class InMemoryDomainEventOutbox<T extends AnyAppEvent>
  implements DomainEventOutbox<T>
{
  ...
  private _messages: Record<
    string,
    { event: T; status: 'PENDING' | 'PROCESSED' }
  > = {};
