...
export class NoDriverAvailableListener implements AppEventListener<NoDriverAvailable> {
  ...
  public readonly eventHandlers = [
    ...
    (event: NoDriverAvailable) => this.publishExternalNoDriverAvailableEvent(event),
  ]

  constructor(private readonly eventPublisher: EventPublisher) {}

  async publishExternalNoDriverAvailableEvent({ id, occurredAt, data }: NoDriverAvailable) {
